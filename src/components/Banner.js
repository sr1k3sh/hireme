        ...
        <React.Fragment>
            <section className="container-xl">
                <div className="banner" ref={bannerRef}>
                    <div className="banner__slogan-wrapper">
                        <h1 className="banner__h1">Hello everyone!! I'm Rikesh</h1>
                        <p className="banner__p">Helping people turn their ideas into
                    ...
                    <div className="banner__slogan-img">
